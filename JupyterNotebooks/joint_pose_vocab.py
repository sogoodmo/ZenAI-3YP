...
vocab_dict = { 
    ...
    'WarriorII_R' : {
        0 : ('raising', 'lowering', 'Your arms may not be parallel to the ground, You can try to fix this by making them more parallel.'),
        2 : ('straightening', 'bending', 'Your arms may not be straight, You can try to fix this by extending your arms as far as you can.'),
        4 : ('sinking', 'raising', 'Your hips may not be bent the correct amount, You can try to fix this by adjusting your hips vertically untill your bent leg is at a right angle.'),
        6 : ('bending', 'straightening', 'Your knees may not be bent the correct amount, You can try to fix this by making sure your knee perpendicular to the floor.'),
