...
from ZenAI_helper import calc_angle, extract_joint_angles, extract_joint_cords, is_left_pose, is_down_tree, cosine_similarity, create_skeleton_video_display, create_error_screen, create_live_video_display
...
def process_image_dl(image, last_pose, model: Model, SCORE_DIFFICULTY, start_time=0):
